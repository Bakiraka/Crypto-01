...
if __name__ == '__main__' :
    ...
    clientpkencode = rsa.decryptblock(fileUtil.recupKey('banqueSk'), rsaClient [0])
    clientpkencode2 = rsa.decryptblock(fileUtil.recupKey('banqueSk'), rsaClient [1])
    clientpkdecode = rsa.encryptblock(fileUtil.recupKey('banquePk'), clientpkencode)
    clientpkdecode2 = rsa.encryptblock(fileUtil.recupKey('banquePk'), clientpkencode2)
